...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2022-07-07T19:00:00Z"), user1);
        Order o2 = new Order(null, Instant.parse("2022-07-06T15:00:00Z"), user2);
        Order o3 = new Order(null, Instant.parse("2022-07-05T12:00:00Z"), user1);
        Order o4 = new Order(null, Instant.parse("2022-07-06T08:00:00Z"), user2);
